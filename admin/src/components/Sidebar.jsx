    ...
    <div className='min-h-screen bg-white border-r border-white'>
      {
        aToken && <ul className='text-[#515151] mt-5'>
            ...
            <NavLink className={({isActive})=> `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F2FF] border-r-4 border-primary' : ''} `} to={'/all-appointment'}>
      ...
      }
      {
        dToken && <ul className='text-[#515151] mt-5'>
            ...
            <NavLink className={({isActive})=> `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F2FF] border-r-4 border-primary' : ''} `} to={'/doctor-appointment'}>
                <img src={assets.appointment_icon} alt="" />
                <p className='hidden md:block'>Appointment</p>
            </NavLink>
